...
(function () {
  ...
  function asIcon (_ref) {
    ...
    if (transformIsMeaningful(transform) && main.found && !mask.found) {
      ...
      attributes['style'] = joinStyles(_objectSpread2({}, styles, {
  ...
  function makeLayersTextAbstract(params) {
    ...
    var attributes = _objectSpread2({}, extra.attributes, {}, title ? {
      'title': title
    } : {}, {
      ...
      if (alreadyProcessedPseudoElement && !fontFamily) {
        ...
        if (iconName && (!alreadyProcessedPseudoElement || alreadyProcessedPseudoElement.getAttribute(DATA_PREFIX) !== prefix || alreadyProcessedPseudoElement.getAttribute(DATA_ICON) !== iconIdentifier)) {
          ...
          findIcon(iconName, prefix).then(function (main) {
            var abstract = makeInlineSvgAbstract(_objectSpread2({}, meta, {
              icons: {
                main: main,
  ...
  var icon = resolveIcons(function (iconDefinition) {
    ...
    return apiObject(_objectSpread2({
      ...
      return makeInlineSvgAbstract({
        ...
        prefix: prefix,
        iconName: iconName,
        transform: _objectSpread2({}, meaninglessTransform, {}, transform),
        symbol: symbol,
        title: title,
        maskId: maskId,
        titleId: titleId,
  ...
  function bootstrap() {
    ...
    namespace.hooks = _objectSpread2({}, namespace.hooks, {
      addPack: function addPack(prefix, icons) {
        namespace.styles[prefix] = _objectSpread2({}, namespace.styles[prefix] || {}, {}, icons);
        build();
        autoReplace();
      },
